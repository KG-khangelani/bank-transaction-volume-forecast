...
def create_features(data_dir='data/inputs'):
    ...
    features = features.with_columns([
        # Month-End Activity Cluster:
        # 'late_month_txn_count_3m' is a top 10 feature, indicating that transaction
        # volume spikes associated with the end of the month are highly predictive.
        # To reinforce this signal, we sum the three most related temporal volume 
        # markers (late-month, month-end, and payday windows).
        #
        # Unlike previous attempts that combined disparate signals (e.g., system + seasonal),
        # this creates a unified, additive cluster of a single behavior type.
        # This provides a stable, linear reinforcement of a known primary driver.
        (
